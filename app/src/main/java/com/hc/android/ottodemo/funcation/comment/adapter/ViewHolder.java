...
public class ViewHolder {
    ...
    public static ViewHolder get(View convertView, ViewGroup parent, Context context, int layoutId, int position) {
        if (convertView == null) {
            return new ViewHolder(parent, context, layoutId, position);
        } else {
    ...
    public ViewHolder setSimpleImgUri(int viewId, String url) {
        ...
        LogUtil.getInstance().debug("jam", "---------------" + url);
        LogUtil.getInstance().debug("jam", "---------simpleDraweeView------" + simpleDraweeView);
